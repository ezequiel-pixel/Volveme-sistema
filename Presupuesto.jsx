  ...
  return (
    <div className="bg-ink-light/10">
      ...
      >
        ...
        {/* Así vivimos nuestros eventos — collage simple en 2x3.
            Estas 6 fotos (collage-1.jpg a collage-6.jpg) ya vienen
            recortadas a cuadrado DE ANTEMANO (no con CSS al momento de
            generar el PDF) — por eso salen todas parejas, sin depender
            de que el motor del PDF calcule bien ningún recorte. */}
      ...
      >
        ...
        <section className="pres-page flex flex-col bg-paper">
          ...
          {/* Imagen completa, sin recortar (nada de object-fit/cover):
              el motor que genera el PDF a veces calcula mal ese recorte
              y estira la foto. Así, natural, es imposible que salga mal. */}
          <div className="mx-10 rounded-sm overflow-hidden">
            <img src="/images/portada.jpg" alt="" className="w-full h-auto block" />
          </div>
